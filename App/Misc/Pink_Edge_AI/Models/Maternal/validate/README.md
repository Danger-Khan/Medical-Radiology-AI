# Models/Maternal/validate/

Drop fetal ultrasound images here that you just want a quick prediction on — **no known label
needed**, this folder isn't used to build the template (see `../positive/` and `../negative/` for
that). Run:
